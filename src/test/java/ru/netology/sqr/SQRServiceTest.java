...
class SQRServiceTest {
    @ParameterizedTest
    @CsvSource(value = {"from 10 to 99 range 0-10, 0, 0,10",
    ...
    void SQR(String testName, int expected, int lowlimit, int highlimit) {
        SQRService sqrService = new SQRService();
        int actual = sqrService.squareOfNumbers(lowlimit, highlimit);
